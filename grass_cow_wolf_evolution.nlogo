globals [ maxAngle count-cow count-wolf]
...
to setup
  ...
  ;; randomly distribute grass chips
  ask patches
  [ if random-float 100 < density
    [ set pcolor green ] ]

  ;; randomly distribute cow
  create-cows number-cow [
    set color white
  ...
  set count-cow number-cow
  set count-wolf number-wolf
end
...
to search-for-cow
  ifelse any? cows-here
  [ eat-cow ]
  [ let prey one-of cows in-radius 10
    ifelse prey != nobody
    [ face prey
      fd 3
      set energy energy - 1
...
"Cow" 1.0 0 -12345184 true "" "plot count-cow"
"Wolf" 1.0 0 -7858858 true "" "plot count-wolf"
